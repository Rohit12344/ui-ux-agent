...
function ChatBox() {
  return (
    <div className="w-[90vw] sm:w-[50vw] mx-auto mb-4 space-y-1 bg-input/80 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 p-4 rounded-3xl ">
      <Textarea
